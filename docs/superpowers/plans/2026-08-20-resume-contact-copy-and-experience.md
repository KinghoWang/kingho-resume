...
```bash
DEMO_BASE_URL=http://127.0.0.1:52786 playwright test tests/resume-content.spec.js --grep "contact controls copy|contact controls report|WeChat dialog" --workers=1
```
...
```bash
DEMO_BASE_URL=http://127.0.0.1:52786 playwright test tests/resume-content.spec.js --grep "three project cases|execution-level copy|compact work layout" --workers=1
```
...
```bash
DEMO_BASE_URL=http://127.0.0.1:52786 playwright test tests/resume-content.spec.js --grep "three project cases|execution-level copy|compact work layout|contribution claims" --workers=1
```
...
```bash
DEMO_BASE_URL=http://127.0.0.1:52786 playwright test --workers=1
```
